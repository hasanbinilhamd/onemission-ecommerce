...
import {
  ...
  subscribeNewsletter,
} from "../../services/api/newsletterService";
...
const FOOTER_LOGO =
  "https://ik.imagekit.io/edyl3oplm/Onemission/logos/AMAN_ONEMISSION.png?updatedAt=1782542636942";
const FOOTER_NEWSLETTER_SUCCESS_TITLE = "Welcome to ONEMISSION.";
const FOOTER_NEWSLETTER_SUCCESS_DESCRIPTION =
...
const COMMUNITY_LINKS: readonly FooterCommunityItem[] = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/onemissionclo/",
    isExternal: true,
    icon: Instagram,
  },
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@hasanbinilhamd",
    isExternal: true,
    icon: Music2,
  },
  {
    label: "YouTube",
    href: "https://www.youtube.com/@onemissionworld",
    isExternal: true,
    icon: Youtube,
  },
] as const;
    ...
    <div style={{ borderTop: `1px solid ${FOOTER_BORDER}` }}>
      ...
      >
        <div style={{ overflow: "hidden" }}>
          <div style={{ display: "grid", gap: "12px", padding: "2px 0 18px" }}>
            {children}
          </div>
        </div>
      </div>
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
        ...
        <div style={{ minWidth: 0, display: "grid", gap: "6px" }}>
          ...
          {Array.isArray(toastState.details) &&
          toastState.details.length > 0 ? (
            <ul
              style={{
                margin: 0,
                paddingLeft: "18px",
...
function ShopeeDestination() {
  ...
  return (
    ...
    >
      {/* <ShopeeWordmark /> */}
      <img src="Shopee.svg" className="h-10" alt="Shopee" />
  ...
  const handleSubmit = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      if (
        ...
        !isValidNewsletterEmail(normalizedEmail)
      ) {
        setToastState({
          type: "error",
      ...
      try {
        ...
        const message =
          error instanceof NewsletterSubscribeError
            ? error.message
          ...
          >
            <div className="homepage-footer-brand" style={{ display: "grid" }}>
              ...
              >
                ...
                So, Let's Bring Back The Value, Because Muslim Values Matter.
                Barakallahu fiikum.
              </p>
            </div>

            <div
              className="homepage-footer-desktop-links gap-12 sm:grid-cols-2 xl:grid-cols-3"
            ...
            <div className="homepage-footer-mobile-links">
              ...
              <MobileFooterAccordion
                ...
                onToggle={() => setMobileSupportOpen((current) => !current)}
              >
                {SUPPORT_LINKS.map((item) => (
                  <FooterLink key={item.label} item={item} />
                ))}
                ...
                <input
                  ...
                  onFocus={(event) => {
                    event.currentTarget.style.borderColor =
                      "rgba(248,246,242,0.54)";
                    event.currentTarget.style.boxShadow =
                      "0 0 0 3px rgba(248,246,242,0.10)";
